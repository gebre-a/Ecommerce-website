...
// const Checkout = () => {
//   const { getCartItemWithProduct } = useCart()
...
//             <h2 className='checkout-selection-title'>Order summery</h2>
//             {cartItems.map(item => (
//               <div className='checkout-item'>
//                   <img src={item.product.image} alt={item.product.name} className='checkout-item-image' />
//                   <div className='checkout-item-details'>
//                     <h3 className='checkout-item-name'>{item.product.name}</h3>
//                     <p className='checkout-item-price'>Price: ${item.product.price}</p>
//                   </div>
...
//                       <button className='quantity-btn'>+</button>
//                     </div>
//                     <p className='checkout-item-total'>Total: ${item.product.price * item.quantity}</p>
